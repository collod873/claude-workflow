...
describe("the checked-in close gate", () => {
  ...
  it("is registered as a PreToolUse hook the dispatcher runs", () => {
    expect(roster.PreToolUse, "no PreToolUse roster entry runs close-gate.py").toContain("close-gate.py");
  });
});
