...
CASES = [
    ...
    ("allow:comment-quotes-dotenv-read",
     "gh issue comment 91 --body 'Closing record: verified via `cat .env` - MET'",
     "ALLOW"),
    ("allow:comment-quotes-dir-grep",
     "gh issue comment 92 --body 'Closing record: verified via `grep foo dist/` - MET'",
     "ALLOW"),
    ("allow:comment-heredoc-quotes-dotenv-read",
     "gh issue comment 93 --body \"$(cat <<'EOF'\n"
     "Closing record: verified via `cat .env` - MET\n"
     "EOF\n)\"",
     "ALLOW"),
    ("allow:comment-heredoc-quotes-dir-grep",
    ...
    ("allow:file-issue-helper",
     ...
     "ALLOW"),
    ("allow:file-issue-note",
     "core/bin/file-issue note --title x --body-file b.md",
     "ALLOW"),
    ("allow:gh-issue-create-quoted",
     "gh issue comment 5 --body 'run gh issue create later'",
     "ALLOW"),

    ("block:gh-issue-close-alone",
     "gh issue close 5",
     "BLOCK"),
    ("block:gh-issue-close-compound",
     "git push && gh issue close 5",
     "BLOCK"),
    ("block:gh-issue-close-with-comment",
     'gh issue close 5 --comment "a && b"',
     "BLOCK"),
    ("block:gh-issue-close-api-state",
     "gh api repos/o/r/issues/5 -f state=closed",
     "BLOCK"),
    ("block:gh-issue-close-api-graphql",
     "gh api graphql -f query='mutation { closeIssue(input: {issueId: \"x\"}) { clientMutationId } }'",
     "BLOCK"),
    ("allow:gh-issue-close-quoted",
     "gh issue comment 5 --body 'run gh issue close later'",
     "ALLOW"),

    ("block:push-to-main-named",      "git push origin main",              "BLOCK"),
    ("block:push-to-main-head-ref",   "git push origin HEAD:main",         "BLOCK"),
    ("block:push-to-main-force",      "git push -f origin main",           "BLOCK"),
    ("block:push-to-main-plus-ref",   "git push origin +main",             "BLOCK"),
    ("block:push-to-main-refs-heads", "git push origin refs/heads/main",   "BLOCK"),
    ("block:push-to-main-colon-pair", "git push origin main:main",         "BLOCK"),
    ("block:push-to-main-upstream",   "git push --set-upstream origin main", "BLOCK"),
    ("block:push-to-main-delete",     "git push origin :main",             "BLOCK"),
    ("block:push-to-main-other-remote", "git push upstream main",          "BLOCK"),

    ("allow:push-branch",             "git push origin feat",              "ALLOW"),
    ("allow:push-mainline",           "git push origin mainline",          "ALLOW"),
    ("allow:push-domain",             "git push origin domain",            "ALLOW"),
    ("allow:push-branch-named-main",  "git push origin feature/main-fix",  "ALLOW"),
    ("allow:push-head",               "git push origin HEAD",              "ALLOW"),
    ("allow:push-bare",               "git push",                          "ALLOW"),
    ("allow:push-main-past-operator", "git push origin feat && echo main", "ALLOW"),
    ("allow:push-main-quoted",
     'gh issue comment 5 --body "then run git push origin main"',
     "ALLOW"),
    ("allow:git-log-main",            "git log --oneline main",            "ALLOW"),
...
GUARD_BY_CASE = {
    ...
    "block:gh-issue-close": "gh-issue-close",
    "block:push-to-main": "push-to-main",
