...
# The machine is rebuilt as a small new core in its own folder of this repo, not cut down in place
...
The new core lives in its own folder, never imports the old machine, and a skill and a workflow
