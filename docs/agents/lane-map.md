...
<text class="lm-sub" x="181.3673598656511" y="221" text-anchor="middle">19 ran · 23 skipped · 0 red</text>
...
<text class="lm-sub" x="1057.367359865651" y="221" text-anchor="middle">27 ran · 41 skipped · 0 red</text>
...
<text class="lm-sub" x="1253.367359865651" y="221" text-anchor="middle">19 ran · 23 skipped · 0 red</text>
...
<text class="lm-sub" x="467.6935708070735" y="369" text-anchor="middle">21 ran · 21 skipped · 0 red</text>
...
<text class="lm-sub" x="990.5973922760455" y="517" text-anchor="middle">518 ran · 12 skipped · 0 red</text>
...
<rect class="lm-box lm-model lm-idle" x="667.4191176126014" y="632" width="168" height="56" rx="6"/>
...
<text class="lm-sub" x="578.9215663144548" y="813" text-anchor="middle">10 ran · 15 skipped · 0 red</text>
...
<text class="lm-sub" x="969.7495375913093" y="1109" text-anchor="middle">68 ran · 0 skipped · 3 red</text>
...
<text class="lm-sub" x="952.6712819026942" y="1257" text-anchor="middle">30 ran · 0 skipped · 1 red</text>
...
<text class="lm-sub" x="1148.6712819026943" y="1257" text-anchor="middle">48 ran · 0 skipped · 0 red</text>
...
<text class="lm-sub" x="694.2809893272474" y="1405" text-anchor="middle">33 ran · 0 skipped · 4 red</text>
...
<rect class="lm-box lm-wire lm-idle" x="645.3685599847563" y="1520" width="168" height="56" rx="6"/>
<text class="lm-text" x="729.3685599847563" y="1538" text-anchor="middle">Record ratifications</text>
<text class="lm-sub" x="729.3685599847563" y="1553" text-anchor="middle">0 runs</text>
...
<text class="lm-sub" x="425.4476706754639" y="1701" text-anchor="middle">2 ran · 0 skipped · 0 red</text>
...
<text class="lm-sub" x="817.4476706754639" y="1701" text-anchor="middle">2 ran · 0 skipped · 0 red</text>
</svg>
</div>
...
- **6 lanes hand their issue to you when the runner dies (Shape, Spec, To-Tickets, Acceptance, Implement, Mechanic):** each ends in an `if: always()` step that runs `labels.cli.ts fail`, which swaps the lane label for `needs-human` whenever the job ended red or cancelled. A lane that ends green leaves its label for the next lane to replace, so a green label with no run behind it never outlives the run.
...
|---|---|---|---|---|---|---|
| 01 [Shape](shape-lane-edges.md) | model | `issue labeled`, `issue_comment created` |  | `1-decide`, `1-shaping`, **`needs-human`** (stop), **`shape-refused`** (stop) | 27 / 0 / 0 / 41 | `shape/shape.ts` |
| 01 [Shape — accept](shape-lane-edges.md) | wire | `issue labeled` | `sheet-accepted`, `push to main` | `to-spec` | 19 / 0 / 0 / 23 | `shape/run-accept.ts` |
| 02 [Spec](spec-lane-edges.md) | model | `issue labeled`, `dispatch sheet-accepted` | `prd-sliceable` | `2-questions-open`, `2-speccing`, `prd`, `sliceable` | 21 / 0 / 0 / 21 | `spec/spec.ts` |
...
| 06 [Verify](verify-lane-edges.md) | wire | `push to main`, `dispatch implementation-opened` | `fixer-needed`, `review-wanted` | `6-verifying` | 65 / 3 / 0 / 0 | `integrate/immutability.ts` |
...
| 07 [Review](review-lane-edges.md) | model | `dispatch review-wanted` |  | `7-reviewing`, `lane-07-finding` | 29 / 1 / 0 / 0 | `review/review.ts` |
| 08 [Integrate](integrate-lane-edges.md) | wire | `dispatch implementation-opened` | `graph-changed`, `implementation-opened`, `ratifier-merged`, `push to main` | `8-landing`, **`needs-human`** (stop) | 24 / 4 / 5 / 0 | `integrate/integrate.ts` |
...
| [Bypass counter](bookkeeping-lane-edges.md) | wire | `Verify completed` |  |  | 48 / 0 / 0 / 0 | `watchdog/bypass-counter.ts` |
...
| [Lost-dispatch counter](bookkeeping-lane-edges.md) | wire | `issue labeled` |  |  | 14 / 0 / 5 / 23 | `watchdog/lost-dispatch-counter.ts` |
...
| [Ratify on PRD close](standards-lane-edges.md) | wire | `issue closed` | `ratification-due` |  | 10 / 0 / 0 / 15 | `ratify/prd-close.ts` |
