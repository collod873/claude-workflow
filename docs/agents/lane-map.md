...
<text class="lm-sub" x="181.3673598656511" y="221" text-anchor="middle">13 ran · 32 skipped · 0 red</text>
...
<text class="lm-sub" x="1057.367359865651" y="221" text-anchor="middle">19 ran · 49 skipped · 0 red</text>
...
<text class="lm-sub" x="1253.367359865651" y="221" text-anchor="middle">13 ran · 32 skipped · 0 red</text>
...
<text class="lm-sub" x="467.6935708070735" y="369" text-anchor="middle">15 ran · 30 skipped · 0 red</text>
...
<text class="lm-sub" x="990.5973922760455" y="517" text-anchor="middle">516 ran · 12 skipped · 0 red</text>
...
<text class="lm-sub" x="578.9215663144548" y="813" text-anchor="middle">9 ran · 15 skipped · 0 red</text>
...
<text class="lm-sub" x="1148.6712819026943" y="1257" text-anchor="middle">46 ran · 0 skipped · 0 red</text>
...
<text class="lm-sub" x="694.2809893272474" y="1405" text-anchor="middle">32 ran · 0 skipped · 4 red</text>
...
<text class="lm-sub" x="229.44767067546388" y="1701" text-anchor="middle">6 ran · 0 skipped · 0 red</text>
...
|---|---|---|---|---|---|---|
| 01 [Shape](shape-lane-edges.md) | model | `issue labeled`, `issue_comment created` |  | `1-decide`, `1-shaping`, **`needs-human`** (stop), **`shape-refused`** (stop) | 19 / 0 / 0 / 49 | `shape/shape.ts` |
| 01 [Shape — accept](shape-lane-edges.md) | wire | `issue labeled` | `sheet-accepted`, `push to main` | `to-spec` | 13 / 0 / 0 / 32 | `shape/run-accept.ts` |
| 02 [Spec](spec-lane-edges.md) | model | `issue labeled`, `dispatch sheet-accepted` | `prd-sliceable` | `2-questions-open`, `2-speccing`, `prd`, `sliceable` | 15 / 0 / 0 / 30 | `spec/spec.ts` |
...
| 08 [Integrate](integrate-lane-edges.md) | wire | `dispatch implementation-opened` | `graph-changed`, `implementation-opened`, `ratifier-merged`, `push to main` | `8-landing`, **`needs-human`** (stop) | 23 / 4 / 5 / 0 | `integrate/integrate.ts` |
...
| [Bypass counter](bookkeeping-lane-edges.md) | wire | `Verify completed` |  |  | 46 / 0 / 0 / 0 | `watchdog/bypass-counter.ts` |
...
| [Lost-dispatch counter](bookkeeping-lane-edges.md) | wire | `issue labeled` |  |  | 9 / 0 / 4 / 32 | `watchdog/lost-dispatch-counter.ts` |
...
| [Ratify on PRD close](standards-lane-edges.md) | wire | `issue closed` | `ratification-due` |  | 9 / 0 / 0 / 15 | `ratify/prd-close.ts` |
