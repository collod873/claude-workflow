...
**The criterion carries a well-formed trailing check marker** — an em dash, the label `check:`,
and a single backtick-quoted command naming the one thing that verifies it:
