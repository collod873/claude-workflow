...
Every lane, what wakes it, what it rings, and what stops → [`docs/agents/lane-map.md`](docs/agents/lane-map.md),
generated by `npm run lane-map`; the per-lane walkthroughs are `docs/agents/*-lane-edges.md`.
