...
describe("core/bin/file-issue files a ticket, or refuses it and files nothing (#662)", () => {
  it("files a well-formed ticket through core/post.ts and says where it landed", () => {
