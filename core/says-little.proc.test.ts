...
import { MAIN_RED, briefing, checkRepo, checking, execute, filing, landSession, minting, misshapenTicket, scratch, script, starting, wellFormedTicket, type Run } from "./scenarios.ts";
...
const scenarios: Record<string, Scenario[]> = {
  ...
  "core/bin/brief": [
    ...
    { label: "refusing a claim over the cap", run: () => briefing({ claimed: { "core/ticket-shape.ts": "export const filler = 1;\n".repeat(3000) } }).run() },
  ],
  "core/bin/start": [
