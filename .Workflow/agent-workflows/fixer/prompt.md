...
It is never rewritten, moved or deleted. A red one is telling you the code is still
...
files back in your answer, since a file you edited is already recorded. Do not
...
into the checkout get committed along with it, so put them somewhere outside
