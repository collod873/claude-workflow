...
/** A pass over one labelled issue, alone on the tracker. */
...
describe("the to-build door into lane 06 (#184)", () => {
   ...
   * request to reach the same verdict. The last row is the dispatch-side half of the claims gate
   * (#334, Class 3 of the research note): a body that claims a path no pull request may ever touch
   * reached an implementer unchecked and was refused only at the push, after the run was spent.
   */
  it.each([
    {
