...
const GAUNTLET_MODULES = [
  ...
  ".Workflow/agent-workflows/shared/baseline-gate.ts",
  ".Workflow/agent-workflows/shared/boundaries-baseline.ts",
  ".Workflow/agent-workflows/shared/generate-boundaries-doc.ts",
  ".Workflow/agent-workflows/shared/regenerate-diff-cli.ts",
